...
const complexValue = { simple1: 'value1', simple2: 'value2', nested: { prop1: 'value1' } };
...
describe('Jest-enzyme supports asymmetric matcher', () => {
  it('in toHaveProp', () => {
    ...
    expect(wrapper).toHaveProp('prop1', expect.objectContaining({ simple1: 'value1' }));
  });
  ...
  it('in toHaveState', () => {
    ...
    expect(wrapper).toHaveState('state1', expect.objectContaining({ simple1: 'value1' }));
  });

...
function toHaveProp(
  ...
  return {
    pass,
    message: `Expected <${name(enzymeWrapper)}> "${propKey}" prop values to match but they didn't.`,
    negatedMessage: `Expected <${name(enzymeWrapper)}> "${propKey}" prop values not to match, but they did.`,
    contextualInformation,
  };
}
